...
class Localization extends ChangeNotifier {
  ...
  static const Map<Language, Map<String, String>> _localizedValues = {
    Language.zh: {
      ...
      'participantCountLabel': '当前玩家数',
      'participantsLabel': '参与者',
      'hostLabel': '房主',
      'hostPlayerIdLabel': '房主玩家 ID',
      'youLabel': '你',
      'roomReadyLabel': '房间就绪',
      ...
      'peerEndpointLabel': '对端地址',
      'peerEndpointUnavailable': '暂不可用',
      ...
      'local_game_connection': '本地游戏连接地址',
      'session_details_title': '会话详情',
      'tcp_relay_label': 'TCP: relay',
      'udp_gameplay_label': 'UDP: raw gameplay bridge / 原始 UDP 游戏转发',
      'lan_discovery_helper': '局域网房间发现辅助',
      'disabled_unavailable': '已禁用 / 不可用',
      'lan_discovery_helper_helper': '用于辅助局域网房间发现的独立通道，与主游戏连接分离。',
      'gameplay_traffic': '游戏流量',
      'tcp_gameplay': 'TCP 游戏流量',
      'udp_gameplay': 'UDP 游戏流量',
      'raw_udp_gameplay': '原始 UDP 游戏转发',
      'discovery_helper_traffic': '发现辅助流量',
      'tcp_gameplay_status': 'TCP 游戏',
      'udp_gameplay_status': 'UDP 游戏',
      'advanced_diagnostics_title': '高级诊断',
      'local_game_connection_helper':
      ...
      'connecting_to_backend': '正在连接本地后端，请稍候...',
    },
    Language.en: {
      // General UI
      'app_title': 'Co-opWinG',
      ...
      'hostLabel': 'Host',
      'hostPlayerIdLabel': 'Host player ID',
      'youLabel': 'You',
      ...
      'peerEndpointLabel': 'Peer endpoint',
      'peerEndpointUnavailable': 'Not available yet',
      'secondaryIpEnabledLabel': 'Secondary IP',
      'secondaryIpFallbackLabel': 'Secondary IP fallback',
      'secondaryIpWarningLabel': 'Secondary IP warning',
      'backendAdminLabel': 'Backend admin/elevated',
      ...
      'local_game_connection': 'Local game connection',
      'session_details_title': 'Session details',
      'tcp_relay_label': 'TCP: relay',
      'udp_gameplay_label': 'UDP: raw gameplay bridge',
      'lan_discovery_helper': 'LAN discovery helper',
      'disabled_unavailable': 'disabled / unavailable',
      'lan_discovery_helper_helper': 'Separate auxiliary channel for LAN room discovery, independent from the main gameplay connection.',
      'gameplay_traffic': 'Gameplay traffic',
      'tcp_gameplay': 'TCP gameplay',
      'udp_gameplay': 'UDP gameplay',
      'raw_udp_gameplay': 'Raw UDP gameplay',
      'discovery_helper_traffic': 'Discovery helper traffic',
      'tcp_gameplay_status': 'TCP gameplay',
      'udp_gameplay_status': 'UDP gameplay',
      'advanced_diagnostics_title': 'Advanced Diagnostics',
      'local_game_connection_helper':
      ...
      'connecting_to_backend': 'Connecting to local backend...',
    },
  };
}
