...
* 创建房间 / 加入房间
* UDP Experimental 模式
* Local TCP Forward 模式
* TCP Relay Experimental 模式
* TCP Relay 可靠帧层：
...
* UDP Experimental mode
* Local TCP Forward mode
* TCP Relay Experimental mode
...
* No TCP+UDP Bundle yet.
* No Secondary IP mode yet.
* No automatic port detection yet.
